...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "standup-06-03.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "standup-06-03-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-standup-06-03.json");
