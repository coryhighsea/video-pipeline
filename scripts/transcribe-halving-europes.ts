...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "halving-Europes-31b-bill.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "halving-Europes-31b-bill-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-halving-europes.json");
...
console.log("Step 4: Transcribing (this takes a few minutes)...");
