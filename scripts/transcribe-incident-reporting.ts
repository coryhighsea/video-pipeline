...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "Incident-reporting.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "incident-reporting-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-incident-reporting.json");
