...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "shorts", "scotch-soda.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "shorts", "scotch-soda-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-scotch-soda.json");
