...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "personally-liable.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "personally-liable-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-personally-liable.json");
