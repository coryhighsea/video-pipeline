...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "incident-reporting-2.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "incident-reporting-2-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-incident-reporting-2.json");
