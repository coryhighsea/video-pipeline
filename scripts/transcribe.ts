...
const INPUT_VIDEO = path.join(PUBLIC_DIR, "what-is-nis2-2.mp4");
const AUDIO_WAV = path.join(PUBLIC_DIR, "what-is-nis2-2-audio.wav");
const OUTPUT_JSON = path.join(PUBLIC_DIR, "captions-what-is-nis2-2.json");
